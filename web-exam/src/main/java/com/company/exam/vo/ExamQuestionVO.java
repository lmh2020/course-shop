 ...
 */
@Data
public class ExamQuestionVO extends BaseEntity implements QuestionSortable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExamQuestionVO)) return false;
        ExamQuestionVO that = (ExamQuestionVO) o;
