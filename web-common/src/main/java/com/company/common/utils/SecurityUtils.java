...
public class SecurityUtils {
    ...
    public static String getUsername() {
        try {
            ...
            throw new CustomException("获取用户账户异常", HttpStatusEnum.UNAUTHORIZED);
        }
    }
    ...
    public static LoginUser getLoginUser() {
        try {
            ...
            throw new CustomException("获取用户信息异常", HttpStatusEnum.UNAUTHORIZED);
        }
    }
    ...
    public static Long getLoginUserId() {
        try {
            ...
            throw new ServiceException("获取用户信息异常", HttpStatusEnum.UNAUTHORIZED);
        }
    }
